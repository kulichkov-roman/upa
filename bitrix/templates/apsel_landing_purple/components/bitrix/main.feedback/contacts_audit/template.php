	...
	<div class="container">
		...
		else
		{
			...
			<p class="section-description">
                <strong>
				    Мы предлагаем:</br>
                    Создать и запустить для Вас надежный, качественный сайт с высокой конверсией! Настраиваем Контекстную рекламу!
				    И Вы начинаете получать новых клиентов и доход!
                </strong>
			</p>
			<?
		}
